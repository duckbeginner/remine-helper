...
| :--- | :--- | :---: | :---: |
| **`core.json`** | 초기 구동용 초경량 헤드 데이터 (최신 영상, 라이브 상태, X 피드, 최근 1~2개월 스케줄) | 매 20분 | **<= 40 KB** (최대 80 KB) |
| **`schedules.json`** | 마스터 스케줄 전수 아카이브 (데뷔 전부터 현재까지의 모든 스케줄) | 매 20분 | **<= 300 KB** (최대 450 KB) |
