...
export const ICONS = {
  ...
  themuze: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="63 111 1127 622"><path fill="currentColor" d="M257 111H645L277 733H63L339 267H165ZM704 111H918L549 733H335ZM977 111H1190L914 577H1088L997 733H608Z"/></svg>`,
...
export const CHANNEL_DATA_MAP = {
  ...
  themuze: {
    name: 'THE MUZE Entertainment',
    url: 'https://themuze.kr/',
    svg: ICONS.themuze
  }
};
