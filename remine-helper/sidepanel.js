...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderDCEmbeds() {
    ...
    // container.innerHTML = `<iframe src="https://m.dcinside.com/board/rescene1" title="DC" style="width: 100%; height: 250px; transition: height 0.3s ease;" frameborder="0" ></iframe>`;
