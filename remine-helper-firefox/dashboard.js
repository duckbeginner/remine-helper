  ...
  ntTabButtons.forEach(btn => {
    btn.addEventListener("click", () => {
      ...
      if (targetId === "ntTabInsta" && !ntInstaLoaded) {
        ...
        document.getElementById("ntDCFeedList").innerHTML = `<iframe src="https://m.dcinside.com/board/rescene1" style="width: 100%; height: 100%;" frameborder="0" sandbox="allow-scripts allow-same-origin allow-forms allow-popups allow-same-site-none-cookie"></iframe>`;
        ntDCLoaded = true;
      }
    });
  });
